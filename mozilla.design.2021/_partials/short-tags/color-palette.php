...
?>
<div class="page-section page-section--color-table color-table">
    <div class="row">

    <?php if( $style == 'centered' ): ?>
      <div class="col-12">
        <div class="color-table color-table--centered">
          <?php
    ...
    <?php if( $style == 'full' ):
        ...
        <div class="color-table color-table--full">
            <table>
            <tbody>
        ...
        <div class="col-12">
        <div class="color-table color-table--gradient">
            <noscript>
